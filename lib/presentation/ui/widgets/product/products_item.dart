...
class ProductItem extends StatelessWidget {
  ...
  const ProductItem({super.key,required this.image,required this.name,required this.price, this.promo=false,required this.id,required this.rating,required this.reference,required this.supplier});
                                ...
                                children: [
                                  ...
                                  //  ),
                                   ...
                                   Padding(
                                     ...
                                     child: SizedBox(width: 130.w, child: Text(name,style: AppTextStyle.smallBlackTitleTextStyle, overflow: TextOverflow.ellipsis,  maxLines: 1,
                                      softWrap: false,)),
                                   ),
                                        Padding(
                                     padding: const EdgeInsets.symmetric(horizontal:8.0,vertical: 1),
                                     child: SizedBox(width: 130.w, child: Text('Ref: $reference',style: AppTextStyle.smallBlackTextStyle, overflow: TextOverflow.ellipsis,  maxLines: 1,
                                      softWrap: false,)),
                                   ),
                                   SizedBox(
                                    width: 145.w,
                                     ...
                                     padding: const EdgeInsets.only(left:8.0,right: 8,bottom: 4),
                                       child: Row(
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                         children: [
                                              SizedBox(width: 70.w, child: Text(supplier,style: AppTextStyle.smallGreyTextStyle,overflow: TextOverflow.ellipsis,)),
